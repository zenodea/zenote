  ...
  return (
    <ul className="relative space-y-0.5">
      ...
      {nodes.map((node) => {
        ...
        return (
          <li key={node.slug} className="group/row flex items-center">
            <Link
              href={href}
              style={fileIndent}
              ...
              className={`block min-w-0 flex-1 truncate rounded py-1.5 pr-2 hover:bg-foreground/10 coarse:py-2.5 ${
